...
is the drag-and-drop workflow builder where users have access to over 50 configurable data operations
...
<br />
Additionally, I actively contributed to the front-end development using JavaScript, React, HTML, and CSS. This hands-on involvement allowed me to directly influence the implementation,
