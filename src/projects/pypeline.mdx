...
<div className="imageContainer">
  <img src="/images/pypeLine/pypeline1.png" className="imageBordered" />
  <div className="imageCaption">
    <p>Various notes from brainstorming sessions and user testing</p>
  </div>
</div>
...
<br />
<div className="imageContainer">
  <img src="/images/pypeLine/pypeline2.png" className="imageBordered" />
  <div className="imageCaption">
    <p>Example of the sandbox with one node</p>
  </div>
</div>
...
<br />
<div className="imageContainer">
  <img src="/images/pypeLine/pypeline3.png" className="imageBordered" />
  <div className="imageCaption">
    <p>Example of the “Join” node modal</p>
  </div>
</div>
...
<br />
<div className="imageContainerDouble gap-20">
  <div className="imageContainer">
    <img src="/images/pypeLine/pypeline4.png" />
    <div className="imageCaption">
      <p>Example of the “Join” node modal</p>
    </div>
  </div>
  <div className="imageContainer">
    <img src="/images/pypeLine/pypeline5.png" />
    <div className="imageCaption">
      <p>Example of the “Join” node modal</p>
    </div>
  </div>
...
<br />
<div className="imageContainer">
  <div className="self-stretch grid auto-cols-fr grid-flow-col gap-4">
    <img
      src="/images/pypeLine/pypeline6.png"
      className="imageBordered flex-1 object-contain"
    />
    <img
      src="/images/pypeLine/pypeline7.png"
      className="imageBordered flex-1 object-contain"
    />
  </div>
  <div className="imageCaption">
    <p>Final designs for “Pypelines” and “Files” screens</p>
  </div>
</div>
...
<br />
**1. Taking ownership and foster a UX design culture.** As the sole designer on the
team, I developed my leadership abilities by taking ownership of the designs and
...
<br />
**2. Creating and maintaining design system.** My experience as the founding designer
for this project provided me with invaluable insights into creating and managing
a consistent and scalable design system, along with an understanding of the challenges
and complexities involved. Through hands-on experience and continuous learning, I
...
<br />
**3. Adapting to evolving business requirements.** Throughout the project, one of
the key challenges our team faced was adjusting to the dynamic nature of business
