...
topBannerImage: "/images/pypeLine/pypeLine0.png"
...
<ImageContainer
  images={["/images/pypeLine/pypeLine1.png"]}
...
<br />
<ImageContainer
  images={["/images/pypeLine/pypeLine2.png"]}
...
<br />
<ImageContainer
  images={["/images/pypeLine/pypeLine3.png"]}
...
<div className="flex flex-wrap gap-x-20 gap-y-4 justify-center items-end">
  <ImageContainer
    images={["/images/pypeLine/pypeLine4.svg"]}
    description="Previous node UI"
  />
  <ImageContainer
    images={["/images/pypeLine/pypeLine5.svg"]}
...
<br />
<ImageContainer
  images={["/images/pypeLine/pypeLine6.png", "/images/pypeLine/pypeLine7.png"]}
