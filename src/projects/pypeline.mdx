...
<ImageContainer images={["/images/pypeLine/pypeLine1.png"]} description="Various notes from brainstorming sessions and user testing" imageBordered />
...
<br />
<ImageContainer images={["/images/pypeLine/pypeLine2.png"]} description="Example of the sandbox with one node" imageBordered />
...
<br />
<ImageContainer images={["/images/pypeLine/pypeLine3.png"]} description="Example of the “Join” node modal" imageBordered />
...
<br />
<div className="flex flex-wrap gap-x-20 gap-y-4 justify-center items-end">
  <ImageContainer images={["/images/pypeLine/pypeLine4.svg"]} description="Previous node UI" />
  <ImageContainer images={["/images/pypeLine/pypeLine5.svg"]} description="New node UI" />
</div>
...
<br />
<ImageContainer images={["/images/pypeLine/pypeLine6.png", "/images/pypeLine/pypeLine7.png"]} description="Final designs for “Pypelines” and “Files” screens" imageBordered />
...
<div className="projectColorBlock pb-0 pl-0" style={{ backgroundColor: "#EDEFFA" }}>
  <img src="/images/pypeLine/pypeLine8.png" className="bg-cover" />
</div>
